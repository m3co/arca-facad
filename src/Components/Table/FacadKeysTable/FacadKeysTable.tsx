...
interface FacadKeysTableProps {
  rows: State['Source']['FACAD-preCFT-AAU-Key'],
}

const FacadKeysTable: React.FunctionComponent<FacadKeysTableProps> = ({
  rows,
}) => {
